package MainPackage {
	...
	inst ChainOfResponsibilityProtocolPT  with RequestInitiator => Button;
	inst GuiWidgets;
	...
	public class Main {
		...
		public static void main(String[] args) {
			...
			ChainLogistics.setSuccessor(button, panel);
			ChainLogistics.setSuccessor(panel, frame); 
	...
	class Panel adds implements Handler {
		public boolean acceptRequest(Request request) { 
	...
	class Frame adds implements Handler {
	...
	class ChainOfResponsibilityException adds {  
