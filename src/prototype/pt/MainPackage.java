package MainPackage {
	...
	public class Main {
	    ...
	    public static void main(String[] args) {
			...
			copyA1 = (StringPrototypeA)  originalA.cloneObject(); // (StringPrototypeA) StringPrototypes.aspectOf().cloneObject(originalA);
			copyB1 = (StringPrototypeB) originalB.cloneObject(); // (StringPrototypeB) StringPrototypes.aspectOf().cloneObject(originalB);
			...
			copyA2 = (StringPrototypeA) originalA.cloneObject(); // (StringPrototypeA) StringPrototypes.aspectOf().cloneObject(originalA);
