     ...
     */
 	class Colleague  {
	   ...
	   /**
	     ...
	     */
		protected abstract pointcut change();
	
		/**
		 * Call updateObserver to update each observer.
		 */  
		after change() {
			notifyMediator(getMediator());
		}
	     ...
	     */
		protected abstract void notifyMediator(Mediator m);
	}	
